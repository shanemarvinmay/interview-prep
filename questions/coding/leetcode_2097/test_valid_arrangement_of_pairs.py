from questions.coding.leetcode_2097.valid_arrangement_of_pairs import Solution

import pytest

@pytest.mark.parametrize('pairs, expected', [
    # ([[5,1],[4,5],[11,9],[9,4]], [[11,9],[9,4],[4,5],[5,1]]),
    # ([[1,3],[3,2],[2,1]], [[2, 1], [1, 3], [3, 2]]),
    ...
    [[999, 990], [990, 614], [614, 740], [740, 452], [452, 847], [847, 538], [538, 961], [961, 999], [999, 452], [452, 618], [618, 320], [320, 624], [624, 485], [485, 307], [307, 903], [903, 503], [503, 284], [284, 138], [138, 18], [18, 949], [949, 175], [175, 246], [246, 945], [945, 356], [356, 511], [511, 277], [277, 164], [164, 99], [99, 138], [138, 538]]),
])
def test_validArrangement(pairs, expected):
    sol = Solution()

    got = sol.validArrangement(pairs)
